                    ...
                    @foreach ($posts as $post)
                        <tr>
                            ...
                            <td class="px-4 py-2 whitespace-nowrap text-gray-700">
                                @if($post->image)
                                    <img src="{{ Storage::url($post->image) }}" alt="{{ $post->title }}" class="h-12 w-16 object-cover rounded">
                                @else
                            ...
                            <div class="flex space-x-2">
                                ...
                                <div class="view-ajax-container"> 
                                <view-ajax :postslug="{{ json_encode($post->slug) }}"/>
                                </div>
                                @if($post->trashed())
                                ...
                                <a href="{{ route('posts.edit', $post->id) }}"
                                    class="px-3 py-1 text-xs font-medium text-white bg-blue-600 rounded hover:bg-blue-700">Edit</a>
                                {{-- <a href="#"
